...
6. **[ ⏳ جاري العمل] صفحة التسجيل (Register)** — تحديث النصوص والتصميم ليتوافق مع هوية "تأهيل لسوق العمل" الجديدة، بدلاً من النصوص الافتراضية.
7. **[ ] تنظيف الكود (Cleanup)** — حذف الملفات الغير مستخدمة بعد انتهاء الواجهات.
8. **[ ] إضافة الجلسات من لوحة الأدمن**
9. **[ ] نظام الشهادات**
10. **[ ] Deployment + ربط الدومين + Google OAuth**
