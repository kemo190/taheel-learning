...
8. **[ ] Admin Management Pages** — لوحة تحكم الأدمن (Tracks, Sessions, Instructors).
9. **[ ] نظام الشهادات** — ربط صفحة الشهادات بقاعدة البيانات.
10. **[مكتمل ✅ عبر إعدادات المستخدم] Deployment + ربط الدومين + Google OAuth** — تم تجهيز الكود 100% وإعداد `middleware.js` وتقديم خطة للمستخدم لربط الدومين من لوحة تحكم Supabase وGoogle Cloud.
11. **[ ⏸️] Employment Module** — بانتظار قرار العميل.
