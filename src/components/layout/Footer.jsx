          ...
          <div className="order-3 flex flex-col justify-start">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="z-10 flex items-center gap-4 mt-2">
                <a href="https://www.facebook.com/EYouthLearning/" target="_blank" rel="noreferrer" className="text-[#0b2646] hover:text-[#0b2646]/70 transition-colors">
                  <svg width="24" height="24" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                ...
                <a href="https://x.com/eyouthlearning" target="_blank" rel="noreferrer" className="text-[#0b2646] hover:text-[#0b2646]/70 transition-colors">
                  <svg width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                ...
                <a href="https://eg.linkedin.com/company/eyouth" target="_blank" rel="noreferrer" className="text-[#0b2646] hover:text-[#0b2646]/70 transition-colors">
                  <svg width="24" height="24" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                ...
                <a href="https://www.instagram.com/eyouthlearning/" target="_blank" rel="noreferrer" className="text-[#0b2646] hover:text-[#0b2646]/70 transition-colors">
                  <svg width="24" height="24" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
