        ...
        <div className="relative grid w-full grid-cols-2 gap-6 pt-8 pb-6 md:grid-cols-2 md:pt-12 xl:grid-cols-4">
          <div className="relative order-0">
            ...
            <ul className="flex flex-col gap-2">
              ...
              <li><a href="https://careers.eyouthlearning.com" target="_blank" rel="noreferrer" className="text-[#0b2646] hover:text-[#0b2646]/80 transition-colors">الوظائف</a></li>
              <li><Link className="text-[#0b2646] hover:text-[#0b2646]/80 transition-colors" href={`/${locale}/about-us`}>عن eyouth</Link></li>
            </ul>
          </div>
          
          <div className="relative order-2 col-span-2 md:order-1 md:col-span-1">
            <h2 className="text-[#0b2646] mb-3 text-[1.375rem] font-bold">eyouth للاعمال</h2>
            <ul className="flex flex-col gap-6">
              <li><a href="https://eyouthbusiness.com" target="_blank" rel="noreferrer" className="rounded-full border border-[#FBBC04] px-4 py-1 text-[#FBBC04] hover:bg-[#FBBC04]/10 transition-colors md:rounded-lg md:px-4 md:py-1 inline-block">eyouth للاعمال</a></li>
          ...
          <div className="order-3 flex flex-col justify-start">
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:support@eyouthlearning.com" className="text-[#0b2646] hover:text-[#0b2646]/80 transition-colors inline-flex items-center gap-2 whitespace-nowrap">
