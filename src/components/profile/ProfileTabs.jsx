...
export default function ProfileTabs({ locale, profile, user, dict }) {
  ...
  const confirmDelete = async () => {
    try {
      ...
      toast.success(
        dict?.profile?.deleteModal?.deleteSuccess ||
  ...
  return (
    <div
      className="w-full flex flex-col xl:flex-row gap-6 md:gap-8 my-6"
      dir={isRtl ? "rtl" : "ltr"}
    >
          ...
          <div className="flex flex-col p-3 gap-2">
            ...
            <div className="xl:mt-2 xl:pt-2 xl:border-t border-gray-100 flex items-center justify-center shrink-0">
              ...
              >
                ...
                {isDeleting
                  ? dict?.profile?.deleteModal?.deleting || "Deleting..."
      ...
      {showDeleteModal && (
        ...
        >
          <div
            ref={modalRef}
            tabIndex="-1"
            className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden relative outline-none"
          >
            {/* Close Button */}
            <button
            ...
            <div className="p-8 flex flex-col items-center text-center">
              ...
              <div className="mb-6 relative flex justify-center items-center">
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="relative z-10 text-red-500 fill-red-50"
                >
              ...
              <h3
                ...
                className="text-xl font-bold text-[#0b2646] mb-3"
              >
                {dict?.profile?.deleteModal?.deleteConfirmTitle ||
                  "Are you sure you want to delete the account?"}
              </h3>

              {/* Description */}
              <p className="text-gray-500 text-sm font-medium leading-relaxed mb-8 max-w-sm whitespace-pre-line">
                {dict?.profile?.deleteModal?.deleteConfirmDesc ||
              ...
              <div className="flex w-full items-center justify-center gap-3">
                ...
                >
                  {isDeleting ? (
                    ...
                    dict?.profile?.deleteModal?.confirmDelete ||
                    "Confirm Delete"
                  )}
                </button>
              </div>
