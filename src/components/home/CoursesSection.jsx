...
export default function CoursesSection({ dict, locale }) {
  ...
  return (
    <section
      className="w-full overflow-hidden py-16 md:py-24 mx-auto max-w-[96%] min-[1410px]:max-w-[1400px]"
      dir={isRtl ? "rtl" : "ltr"}
    >
      {/* Header Section */}
        ...
        <div className="flex w-max min-w-full">
          {categories.map((category) => (
            <button
              ...
              className={`pb-4 px-2 rtl:ml-8 ltr:mr-8 whitespace-nowrap text-[15px] font-bold transition-colors relative ${
      ...
      <div className="flex justify-center px-4 md:px-0">
        <a
          href={`/${locale}/courses`}
          className="w-full sm:w-auto bg-[#0b2646] hover:bg-[#061528] text-white px-8 py-3.5 rounded-xl font-bold text-[15px] flex items-center justify-center gap-2 transition-colors shadow-md"
        >
          <span>
            {dict.coursesSection.viewAllBtn}{" "}
