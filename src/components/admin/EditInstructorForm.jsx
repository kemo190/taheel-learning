...
import { updateInstructor } from "@/app/actions/adminInstructorActions";

export default function EditInstructorForm({ locale, instructor }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("تم تعديل المدرب بنجاح");
