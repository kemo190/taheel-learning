  ...
  return (
    <div className="flex w-full flex-col overflow-hidden rounded-[20px] border border-[#D6D6D6] bg-white shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="relative h-[200px] w-full bg-gray-50 overflow-hidden">
        ...
        />
        <span
          className={`flex items-center gap-1.5 h-fit w-fit rounded-full rounded-tr-none rtl:rounded-tl-none rtl:rounded-tr-[20px] rounded-bl-none rtl:rounded-br-none px-4 py-1.5 text-center text-[13px] font-bold text-white [&>svg]:size-4 ${badgeColor} absolute bottom-0 right-0 rtl:right-0 rtl:left-auto ltr:left-auto z-10`}
        >
          {isLive ? (
            <svg
      ...
      <div className="flex flex-col px-4 py-4 w-full flex-1">
        ...
        >
          ...
          <div className="flex items-center gap-1.5" dir="ltr">
            {price === 0 ? (
              <>
                ...
                {oldPrice && (
                  <div className="flex items-center gap-1">
                    ...
                    <span className="bg-[#c1131c] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-sm">
                      {discount}
                    </span>
                  </div>
                )}
              ...
              <b className="text-[#0b2646] text-lg font-bold">
                {price}{" "}
                <span className="text-sm font-sans">
                  {dict?.journey?.courseCard?.currency || "ج.م"}
                </span>
              </b>
            )}
          </div>
        ...
        {/* Footer Actions */}
        <div
          className="flex w-full items-center justify-between gap-3 mt-auto pt-2"
          dir="rtl"
        >
          {/* Subscribe Button */}
