...
export default function EmptyState({ title, subtitle, description, imageSrc, locale }) {
  return (
    <div className="flex flex-col items-center justify-center py-12 w-full text-center">
      {/* Title */}
      {title && (
        <h2 className="text-2xl font-bold text-[#0b2646] mb-8">
          {title}
        </h2>
      )}
      ...
      {/* Text Content */}
      <h3 className="text-xl font-bold text-[#0b2646] mb-2">
        {subtitle}
      </h3>
